document.getElementById('loginForm').addEventListener('submit', function(e) {
    ...
    fetch('http://localhost/cabinet/authapi/index.php', { // Remplacez par l'URL correcte de votre AuthAPI
        method: 'POST',
    ...
    .then(data => {
        if(data.jwt) {
            ...
            window.location.href = '/temp.html'; // Redirection vers la page d'accueil
        } else {
